...
class User(models.Model):
    ...
    uuid = models.CharField(
        default=uuid.uuid4, max_length=50, primary_key=True, unique=True)
...
class Zorg(models.Model):
    ...
    profile_photo = models.ImageField(
        upload_to='zorg/profile_photo/', null=True, blank=True, max_length=200)
    cover_photo = models.ImageField(
        upload_to='zorg/cover_photo/', null=True, blank=True, max_length=200)
    photo_1 = models.ImageField(
        upload_to='zorg/zorg_images/', null=True, blank=True, max_length=200)
...
class Zorg_Branche(models.Model):
    zorg = models.ForeignKey(
        Zorg, on_delete=models.CASCADE, null=True, related_name="branches")
...
class Categories(models.Model):
    zorg = models.ForeignKey(
        Zorg, on_delete=models.CASCADE, null=True, related_name='categories')
...
# Whenever the user make an appointment, one record will be stored
# in the "appointment" model but it will add
...
class AppointmentDetail(models.Model):
    ...
    appointment = models.ForeignKey(
        Appointment, on_delete=models.CASCADE, null=True, related_name='appointment')
    # category = models.ForeignKey(Categories, on_delete=models.CASCADE,null=True,
    #                              related_name='category')
    service = models.ForeignKey(
        Service, on_delete=models.CASCADE, null=True, related_name='service')
...
class Advertisment(models.Model):
    """
    This is a model for advertisment
    """
    # zorg = models.ForeignKey(Zorg, on_delete=models.CASCADE, null=True)
